...
delete
    MutualPlaybackEntries, MutualPlaybackOverviews
from MutualPlaybackEntries inner join MutualPlaybackOverviews
on MutualPlaybackEntries.MutualPlaybackOverviewId = MutualPlaybackOverviews.Id
