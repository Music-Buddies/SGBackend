...
namespace SGBackend.Migrations
{
    ...
    [Migration("20230530163750_Follower")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGBackend.Entities.Follower", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserBeingFollowedId", "UserFollowingId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SGBackend.Entities.Follower", b =>
                {
                    b.HasOne("SGBackend.Entities.User", "UserBeingFollowed")
                        .WithMany()
                        .HasForeignKey("UserBeingFollowedId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SGBackend.Entities.User", "UserFollowing")
                        .WithMany()
