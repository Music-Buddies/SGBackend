...
delete MutualPlaybackEntries, MutualPlaybackOverviews from MutualPlaybackEntries inner join MutualPlaybackOverviews on MutualPlaybackEntries.MutualPlaybackOverviewId = MutualPlaybackOverviews.Id
...
delete User from User where User.Name like 'Dummy%'